...
The final output should consist solely of the API plan in markdown format in English, which you will save in docs/api-plan.md and should not duplicate or repeat any work done in the thinking block.
