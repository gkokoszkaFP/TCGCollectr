...
Remember to save your implementation plan as docs/collection-patch-implementation-plan. Ensure the plan is detailed, clear, and provides comprehensive guidance for the development team.
```
